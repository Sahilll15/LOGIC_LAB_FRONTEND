          ...
          <div className="px-6">
            <div className="flex flex-wrap justify-center">
              ...
              <div className="w-full lg:w-4/12 px-4 lg:order-1">
                <div className="flex justify-center py-4 lg:pt-4 pt-8">
                  ...
                  <div className="mr-4 p-3 text-center">
                    <span className="text-xl font-bold block uppercase tracking-wide text-blueGray-600">10</span><span className="text-sm text-blueGray-400">Applied candidates</span>
                  </div>
            ...
            <div className="text-center mt-12">
              ...
              <div className="mb-2 text-blueGray-600 mt-10">
                <i className="fas fa-briefcase mr-2 text-lg text-blueGray-400" />Required Skills - html,css,tailwind,prompt
              </div>
