  ...
  return (
    <div>
      <div className="">
        ...
        <center>
          <button
            class="border hover:scale-95 my-2 duration-300 relative group cursor-pointer text-sky-50  overflow-hidden h-16 w-64 rounded-md bg-sky-200 p-2 flex justify-center items-center font-extrabold"
            onClick={handlePolls}
          >
