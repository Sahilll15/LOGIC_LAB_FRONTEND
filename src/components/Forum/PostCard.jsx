        ...
        <div className="bg-white p-4 rounded-xl mt-2" key={forum._id}>
          <div className="flex flex-wrap gap-4">
            <div>
              <span className="bg-black w-8 h-8  rounded-full">
                <img
                  ...
                  } // Assuming author has a profilePicture field
            ...
            <div>
              ...
              <p>
                Date: {forum.createdAt}, time: {forum.time}
              </p>
            </div>
          </div>
          ...
          {forum.media && (
            <img
              src={"http://localhost:4000/" + forum.media}
              alt="forum image"
          ...
          <div className="flex justify-between">
            <div className="flex flex-wrap gap-4">
              <div className="text-xl flex flex-wrap mt-6">
                <FaRegThumbsUp />{" "}
                <span className="-mt-1">{forum.likes.length}</span>
              </div>
              <div className="text-xl flex flex-wrap mt-6">
                <BiCommentDetail />{" "}
                <span className="-mt-1">{forum.comments.length}</span>
              </div>
            </div>
